# Data Model: Glass Footer

## Entities

### FooterContent
- **copyrightText**: string - The copyright text to display on the left side (e.g., "© 2025 [Your Name]")
- **centerText**: string - The center text to display (e.g., "Built with Next.js & Agentic AI")
...
- **centerText**: string (optional) - Custom center text (defaults to "Built with Next.js & Agentic AI")
...
- **centerText**: Must be non-empty string with 10-50 characters
